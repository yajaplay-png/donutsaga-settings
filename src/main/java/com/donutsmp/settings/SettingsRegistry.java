...
public final class SettingsRegistry {
    ...
    static {
        ...
        SETTINGS.put("notifications", List.of(
                ...
                SettingDef.onOff("auction_alerts", "Auction Alerts", true),
                SettingDef.onOff("order_alerts", "Order Alerts", true),
        ...
        SETTINGS.put("visuals", List.of(
                ...
                SettingDef.onOff("item_worth_lore", "Item Worth Lore", true),
